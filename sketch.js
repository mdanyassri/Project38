...
function setup() {
  ...
  trex = createSprite(50,850,20,50);
  ...
  gameOver = createSprite(displayWidth-50, displayHeight-20/2-550);
  gameOver.addImage(gameOverImg);
  
  restart = createSprite(displayWidth-20, displayHeight-20/2-510);
  ...
  invisibleGround = createSprite(30, 900, displayWidth, 20);
  //invisibleGround.visible = false;
  invisibleGround.shapeColour= "green";
